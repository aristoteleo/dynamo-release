...
# n_points=350, tmax=200, point_start=points[:, i][:, None], point_end=ref_point

# Wang_LAP(n_points, point_start, point_end, F, D=0.1, lambda_=1):
# LAP = Wang_LAP(F=vector_field_function, n_points=350, point_start=points[:, 1][:, None], point_end=ref_point, D=0.1, lambda_=1)
LAP = Wang_LAP(F=vector_field_function, n_points=350, point_start=points[:, 3][:, None], point_end=points[:, 4][:, None], D=0.1, lambda_=1)
