from anndata import read, read_loom, read_csv, read_excel, read_h5ad, read_hdf, read_mtx, read_umi_tools, read_zarr, read_text
...
def load_NASC_seq(dir, delimiter='_', colnames=None):
    ...
    file_names = [fn for fn in os.listdir(dir) if any(fn.endswith(ext) for ext in included_extensions)]
    if len(file_names) == 3:
        ...
        raise Exception("The directory you provided doesn't contain files end with newTable.csv, oldcounts.csv and \
