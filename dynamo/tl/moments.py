...
class moments:
    ...
    def get_all_centered_moments(self):
    ...
    def get_nosplice_centered_moments(self):
...
class estimation:
    ...
    def f_curve_fit(self, t, *params):
        ...
        ret = self.simulator.get_all_centered_moments()
    ...
    def f_lsq(self, params, t, x_data_norm, method='analytical', experiment_type=None):
        ...
        if experiment_type is None:
            ...
            ret = self.simulator.get_nosplice_centered_moments()
    ...
    def fit_lsq(self, t, x_data, p0=None, n_p0=1, bounds=None, sample_method='lhs', method='analytical', experiment_type=None): # what if p0 len doesn't match n_p0: n_p0 is used only when p0 is None
        if p0 is None:
