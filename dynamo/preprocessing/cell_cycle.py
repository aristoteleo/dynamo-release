...
def get_cell_phase(
    ...
    adata.uns["cell_phase_genes"] = dict(
        cell_phase_genes
    )  # CHECK! OrderedDict is not hdf5 serializable, so convert to dict. Need to convert back to OrderedDict when loading if needed.
