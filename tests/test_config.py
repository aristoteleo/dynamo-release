...
def test_config_change():
    ...
    dyn.config.DynamoAdataConfig.data_store_mode = "succint"

    # change class static values wont change config variables
    assert dyn.config.DynamoAdataConfig.data_store_mode == "succint"
    ...
    # test succint mode
    dyn.config.DynamoAdataConfig.update_data_store_mode("succint")
    ...
    assert imported_config.DynamoAdataConfig.data_store_mode == "succint"
